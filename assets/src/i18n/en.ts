const en = {
  translation: {
    ...
    setup: {
      title: "Settings",
      description: "Manage operators, authentication, and standing authority.",
      manageAuthority: "Configure standing authority and limits",
      ...
      disable: "Disable",
      usageScope: "Use for",
      usageAll: "ALL (Default)",
      usageUnset: "Not configured",
      showConnectionDetails: "Manage",
      hideConnectionDetails: "Close",
      checkNeededShort: "Check required",
