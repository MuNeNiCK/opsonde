const en = {
  translation: {
    ...
    setup: {
      ...
      autoReviewerWarning:
        "Auto mode needs an AI connection to review proposed changes (Reviewer). None is assigned, so changes cannot run automatically. Assign another connection to Reviewer or change an existing connection to Both.",
      autoReviewerChangeWarning:
        "Saving this setting leaves no AI assigned to review proposed changes (Reviewer). To run changes in Auto mode, assign another connection to Reviewer.",
      ...
      searchAIServices: "Search AI services",
      searchAIServicesPlaceholder: "Search by service name",
      noAIServicesFound: "No matching AI services.",
      choiceOpenAI: "Connect to an OpenAI-compatible API with an API key and optional endpoint.",
      choiceAnthropic: "Connect to Anthropic Claude with an API key and optional endpoint.",
      cardApiKey: "Connect with an API key.",
      cardOptionalApiKey: "An API key is optional.",
      cardNoCredential: "Connect without an API key.",
      cardServiceAccount: "Connect with a service account.",
      cardOAuth: "Connect with an OAuth access token.",
      noCredential: "This service needs no API key. Set an endpoint if it runs elsewhere.",
      ollamaLocal: "For local Ollama. For Ollama Cloud, choose OpenAI-compatible API.",
      ...
      reasoningHigh: "High",
      reasoningMax: "Max",
      reasoningEffortDescription: "The service may ignore or reject this setting.",
      apiKey: "API key",
      addConnection: "Add connection",
      edit: "Edit",
      editConnectionDescription:
        "Leave the credential blank to keep the saved value. Saving disables this connection and requires a new check.",
      ...
      disable: "Disable",
      usageScope: "Use for",
      usageAll: "Both (Resolver and Reviewer)",
      usageUnset: "Not configured",
      showConnectionDetails: "Settings",
      hideConnectionDetails: "Close",
      noAIConnections: "No AI connections yet.",
      priorityHint: "Lower numbers are selected first; ties follow registration order.",
      saveUsage: "Save use and order",
      usageSaved: "Usage for {{name}} was saved.",
      priorityDescription:
        "Lower numbers are selected first. Ties follow registration order. The rank appears after the connection passes its check and is enabled.",
      ...
      oidcUnconfiguredStatus: "Not configured",
      oidcNotConfigured: "No identity provider configured.",
      oidcAvailable: "OIDC authentication is available.",
      oidcUnavailable: "OIDC authentication is unavailable.",
      oidcConfigure: "Configure connection",
      oidcEdit: "Edit connection",
      ...
      authorityTitle: "AI authority and limits",
      ...
      modes: {
        ...
        auto: {
          name: "Auto",
          description: "Run proposed changes only after a Reviewer approves them.",
        },
        full_access: {
          name: "Full access",
    ...
    onboarding: {
      ...
      steps: {
        ...
        authority: {
          ...
          reviewerRequired: "Auto mode needs an AI connection to review proposed changes.",
    ...
    cases: {
      ...
      actionDecisionRequired: "A decision on the Proposal is required.",
      actionInputRequired: "Operator input is required.",
      actionInterventionRequired: "Review the stop reason, then resume or cancel the Case.",
      ...
      workflow: {
        ...
        map: {
          ...
          waiting: "Waiting for the first investigation record…",
          previousSteps: "{{count}} earlier operations",
          relatedTarget: "Related Target",
          investigate: "Investigate",
          stopped: "Autonomous resolution stopped",
          recoveryReached: "Recovery verification reached",
          stoppedEdge: "Stopped",
          recoveredEdge: "Recovered",
        },
        fields: {
        ...
        stages: {
          ...
          report: {
            ...
            description: "A Report is being generated from the terminal Case revision.",
          },
          complete: {
            label: "Complete",
            description: "Recovery was verified and the Report is available.",
          },
        },
        sources: {
          system: "system",
      ...
      completionSummary: {
        ...
        description: "The Case is recorded as resolved and its report is available.",
        showProgress: "Show progress history",
        hideProgress: "Hide progress history",
        cause: "Observed condition",
        confirmedCondition: "Observed failure condition",
        causeUnavailable: "The cited evidence does not establish a condition.",
        actions: "Remediation performed",
        moreActions: "Show {{count}} more remediations",
        target: "Recovered Target",
        noRemediation: "No remote change",
        recoveryEvidence: "Recovery verification",
        resolverAssessment: "Resolver assessment",
        postActionObservation: "Observed after the change",
        conclusionUnavailable: "The persisted records do not contain a recovery conclusion.",
        verified: "Verified",
        monitoringState: "Monitoring source: {{state}}",
      ...
      status: {
        running: "Running",
        needs_attention: "Automation stopped",
        resolved: "Resolved",
        cancelled: "Cancelled",
      },
      operatorAction: {
        ...
        intervention_required: "Automation stopped",
      },
      runStatus: {
        running: "Running",
    ...
    reports: {
      ...
      automaticOn: "On",
      automaticOff: "Off",
      automaticUpdateFailed: "The setting could not be saved. Its current state was reloaded.",
      title: "Reports",
      description: "Create Case reports and deliver them through verified destinations.",
      requestFailed: "The request failed. Review the values and connection, then try again.",
      refresh: "Refresh",
      ...
      historyDescription: "Review generated reports and their delivery status.",
      ...
      periodTitle: "Period report",
      periodDescription: "Summarize opened Cases and scheduled audit runs by period and target.",
      periodFrom: "From (UTC)",
      periodTo: "Through (UTC, inclusive)",
      periodTarget: "Target",
      allTargets: "All targets",
      showPeriod: "Show summary",
      periodInvalid: "Choose a period of up to 366 days with the end on or after the start.",
      periodAsOf: "Retrieved",
      periodSemantics:
        "Cases are counted by opening time and audits by scheduled time, classified by their state when viewed. Separate Cases for one incident are counted separately. This does not calculate availability or SLA.",
      periodCases: "Cases",
      periodResolved: "Resolved",
      periodAttention: "Needs attention",
      periodAudits: "Scheduled audit runs",
      periodCaseBreakdown: "Case outcomes",
      periodAuditBreakdown: "Audit run outcomes",
      periodTriggerBreakdown: "Origins: {{signal}} signal · {{audit}} audit · {{manual}} manual",
      periodRecovery: "Recovery time",
      periodNoRecoveryMeasurement:
        "No Case has a recorded recovery time, so no average is available.",
      periodAverageRecovery: "Mean across {{count}} measured resolved Cases: {{seconds}} seconds",
      periodUnmeasured: "Resolved Cases without a measurable recovery time: {{count}}",
      periodRecoveryDefinition:
        "Elapsed time from Case opening to monitoring source recovery. This is not time since incident onset.",
      periodDaily: "Daily counts",
      periodDay: "Day (UTC)",
      ...
      recordCounts: "{{operations}} operations · {{verifications}} checks",
      columns: {
        case: "Case / Target",
        generated: "Generated",
        outcome: "Outcome",
        records: "Records",
        format: "Language / Revision",
        delivery: "Delivery",
        actions: "Actions",
      },
