const en = {
  translation: {
    ...
    setup: {
      ...
      disable: "Disable",
      usageScope: "Use for",
      currentUsage: "Current use",
      usageAll: "ALL (Default)",
      usageUnset: "Not configured",
      saveUsage: "Save use and order",
      usageSaved: "Usage for {{name}} was saved.",
      priorityDescription:
        "Lower priority numbers are selected first. Equal numbers follow registration order. Checked, enabled connections appear in the order below.",
      selectionOrder: "AI selection order",
      selectionOrderDescription:
        "Eligible connections are shown in the order used for each role. Reviewer can fall back to the selected Resolver when no Reviewer is eligible.",
      noEligibleAI: "No eligible connection",
