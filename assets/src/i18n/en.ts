const en = {
  translation: {
    ...
    setup: {
      ...
      reviewerReady: "An AI connection is set to review proposed changes (Reviewer).",
      reviewerNotAssigned: "No AI connection is set to review proposed changes (Reviewer).",
      reviewerRequired: "Reviewer setup required",
      autoReviewerWarning:
