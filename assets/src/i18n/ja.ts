const ja = {
  translation: {
    ...
    cases: {
      ...
      reviewProposal: "変更提案を確認",
      requiredDecision: "判断が必要です",
      caseControls: "担当変更と中止",
      cancelConfirmation:
        "中止を要求すると、これ以降の解決作業を停止します。既存の証拠と実行済みの変更はケースに残ります。",
      confirmCancel: "中止を確定",
      rejectConfirmation: "この変更提案を却下し、判断をResolverへ返しますか？",
      confirmReject: "却下を確定",
      approveConfirmation:
        "表示されているTargetとAccess Methodを使い、この正確な変更内容の実行を承認しますか？",
      ...
      situation: {
        ...
        waitingApproval: "Opsondeが正確な変更内容を作成し、判断を待っています。",
        ...
        reviewProposal: "変更提案を確認し、判断してください。",
