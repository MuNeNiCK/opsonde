const ja = {
  translation: {
    ...
    setup: {
      ...
      manageAuthority: "AI権限と制限",
      authorityEntryDescription: "AIが提案した変更の承認方法と、ケースの実行上限を設定します。",
      currentAuthorityMode: "現在の権限モード",
      openAuthority: "権限設定を開く",
      ...
      aiTitle: "AI接続",
      aiDescription: "接続を登録・確認し、用途と選択順を設定します。",
      addAI: "AI接続を追加",
      backToAI: "AIへ戻る",
      backToAITypes: "AI Provider選択へ戻る",
      chooseAIType: "AI Providerを選択",
      chooseAITypeDescription: "Opsondeが利用するサービスを選択し、その接続を設定します。",
      searchAIServices: "AIサービスを検索",
      searchAIServicesPlaceholder: "サービス名で検索",
      noAIServicesFound: "一致するAIサービスがありません。",
      choiceOpenAI: "APIキーと任意のEndpointでOpenAI互換APIへ接続します。",
      choiceAnthropic: "APIキーと任意のEndpointでAnthropic Claudeモデルへ接続します。",
      cardApiKey: "APIキーで接続します。",
      cardOptionalApiKey: "APIキーなしでも接続できます。",
      cardNoCredential: "APIキーなしで接続します。",
      cardServiceAccount: "サービスアカウントで接続します。",
      cardOAuth: "OAuthアクセストークンで接続します。",
      noCredential:
        "このサービスにAPIキーは不要です。別のサーバーを使う場合はエンドポイントを指定してください。",
      ollamaLocal: "ローカルOllama用です。Ollama CloudはOpenAI互換APIを選択してください。",
      ...
      endpointRequired: "エンドポイント",
      aiFields: {
        api_key: "APIキー",
        service_account_json: "サービスアカウントJSON",
        access_token: "OAuthアクセストークン",
        project_id: "クラウドプロジェクトID",
        region: "リージョン",
        deployment: "デプロイ名（任意）",
        api_version: "APIバージョン（任意）",
        chatgpt_account_id: "ChatGPTアカウントID",
      },
      ...
      advancedAI: "詳細設定",
      reasoningEffort: "推論量",
      reasoningEffortDefault: "モデルの初期値",
      reasoningNone: "なし",
      reasoningLow: "低",
      reasoningMedium: "中",
      reasoningHigh: "高",
      reasoningMax: "最大",
      reasoningEffortDescription: "接続先によっては、この設定が無視または拒否されます。",
      apiKey: "APIキー",
      addConnection: "接続を追加",
      edit: "編集",
      editConnectionDescription:
        "保存済みの認証情報を維持する場合は空欄にします。保存すると接続は無効になり、再度の接続確認が必要です。",
      ...
      disable: "無効化",
      usageScope: "用途",
      usageAll: "両方（Resolver・Reviewer）",
      usageUnset: "未設定",
      showConnectionDetails: "詳細設定",
      hideConnectionDetails: "閉じる",
      noAIConnections: "AI接続はまだありません。",
      priorityHint: "優先度は小さい数字から選択します。同じ数字なら登録順です。",
      saveUsage: "用途と順序を保存",
      usageSaved: "{{name}}の用途を保存しました。",
      priorityDescription:
        "優先度は小さい数字から選択します。同じ数字なら登録順です。接続確認後に有効化すると順位が表示されます。",
      connection: "接続",
      priority: "優先度",
      accounts: {
        title: "運用者アカウント",
        ...
        roles: { admin: "管理者", operator: "運用者", viewer: "閲覧者" },
      },
      oidcTitle: "OIDC認証",
      oidcDescription:
        "任意で1つのIDプロバイダーを接続し、既存のOpsondeアカウントへ明示的にリンクします。",
      oidcConnection: "IDプロバイダー",
      oidcUnconfiguredStatus: "未設定",
      oidcNotConfigured: "IDプロバイダーは未設定です。",
      oidcAvailable: "OIDC認証を利用できます。",
      oidcUnavailable: "OIDC認証は利用できません。",
      oidcConfigure: "接続を設定",
      oidcEdit: "接続を編集",
    ...
    cases: {
      ...
      completionSummary: {
        title: "解決サマリ",
        description: "ケースは解決済みとして記録され、レポートを確認できます。",
        showProgress: "進行状況を表示",
        hideProgress: "進行状況を閉じる",
        cause: "観測された状態",
        confirmedCondition: "障害時の確認結果",
        causeUnavailable: "引用された証拠から状態を特定できませんでした。",
        actions: "実施した対応",
        moreActions: "その他{{count}}件の対応を表示",
        target: "復旧したTarget",
        noRemediation: "遠隔変更なし",
        recoveryEvidence: "復旧確認",
        resolverAssessment: "Resolverの判断",
        postActionObservation: "変更後の観測結果",
    ...
    reports: {
      ...
      automaticOn: "有効",
      automaticOff: "無効",
      automaticUpdateFailed: "設定を保存できませんでした。状態を再読み込みしました。",
      title: "レポート",
      ...
      openCase: "Caseを開く",
      openReport: "レポートを開く",
      backToReports: "レポート一覧へ戻る",
      print: "印刷・PDF保存",
      periodTitle: "期間レポート",
      periodDescription: "Caseの受付と定期監査の実行を、期間と対象で集計します。",
      periodFrom: "開始日（UTC）",
      periodTo: "終了日（UTC・当日を含む）",
      periodTarget: "対象",
      allTargets: "すべての対象",
      showPeriod: "集計を表示",
      periodInvalid: "開始日から終了日まで、366日以内の期間を指定してください。",
      periodAsOf: "取得日時",
      periodSemantics:
        "Caseは受付日時、監査は予定日時で数え、表示時点の状態で分類します。同じ障害の複数Caseも個別に数えます。稼働率やSLAは算出しません。",
      periodCases: "Case件数",
      periodResolved: "解決済み",
      periodAttention: "対応が必要",
      periodAudits: "定期監査Run",
      periodCaseBreakdown: "Caseの状態",
      periodAuditBreakdown: "監査Runの状態",
      periodTriggerBreakdown: "起点: Signal {{signal}}件・監査 {{audit}}件・手動 {{manual}}件",
      periodRecovery: "復旧時間",
      periodNoRecoveryMeasurement: "復旧時刻が記録されたCaseがないため、平均時間は算出できません。",
      periodAverageRecovery: "計測可能な解決済みCase {{count}}件の平均: {{seconds}}秒",
      periodUnmeasured: "解決済みCaseのうち復旧時間を計測できないもの: {{count}}件",
      periodRecoveryDefinition:
        "Case受付から監視元の復旧確認までの時間です。障害発生からの時間ではありません。",
      periodDaily: "日別件数",
      periodDay: "日付（UTC）",
