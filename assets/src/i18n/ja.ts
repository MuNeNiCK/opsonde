const ja = {
  translation: {
    ...
    setup: {
      ...
      priorityDescription:
        "優先度は数字が小さいほど先に選ばれます。同じ数字なら登録順です。接続確認済みで有効な接続が下の順序に表示されます。",
      selectionOrder: "AI選択順",
      selectionOrderDescription:
        "各役割で実際に選ばれる接続を順番に表示します。Reviewerが使えない場合は選択済みResolverへフォールバックできます。",
      noEligibleAI: "利用可能な接続がありません",
      connection: "接続",
      priority: "優先度",
      accounts: {
        title: "運用者アカウント",
